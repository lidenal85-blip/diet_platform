...
Контракт:
- таксономия Phase 0 (PATCH-9): ровно 8 имён событий; расширение — отдельное решение
  (C-3.0, 2026-09-19: единственное одобренное владельцем расширение —
  ``meal_status_changed``; прочие имена по-прежнему громко отвергаются);
